# Reviewed-label diagnostic: 2 views
...
Each rerun retains all 24 preselected views: 2 reviewed targets and 22 pseudo-labelled targets. The mixed aggregate is descriptive and is not a human-verified benchmark.
