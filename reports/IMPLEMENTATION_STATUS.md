...
- The editor now identifies the review view, provides general image-region presets, and reports how many newly painted building pixels the validity mask actually scores. This feedback does not alter either mask. View 2 is prepared for the next human review; it remains unapproved.
