...
- The user explicitly accepted an earlier corrected building mask, including visible patches through foliage. They then requested more upper/middle/lower tree gaps while explicitly describing them as uncertain. Version 7 proposes 89 additional building pixels and 430 additional validity pixels, including 341 pixels already labelled as building. Both changed components remain pending; earlier version acceptance is preserved without applying it to changed masks. **Zero complete reviewed mask pairs have been exported or used for evaluation.**
